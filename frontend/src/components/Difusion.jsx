                ...
                <div className="split">
                    <div className="panel">
                        ...
                        <div className="content">
                            <strong style={{ color: 'var(--ink)' }}>Formación y divulgación</strong><br />
                            Mente · trauma · sistemas complejos · bienestar.
                        </div>
                    </div>

                    <div className="callout" style={{ marginTop: 0 }}>
                        <h3>Invitaciones y contenidos</h3>
                        <p>Si quieres, aquí sumamos próximos eventos, temas y medios.</p>
                        <div className="row">
